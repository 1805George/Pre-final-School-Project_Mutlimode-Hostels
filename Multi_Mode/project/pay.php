...
$curl_Tranfer2_post_data = [
    ...
    'AccountReference' => 'Multimode Hostels',
...
if (isset($curl_Tranfer2_response->MerchantRequestID) && isset($curl_Tranfer2_response->CheckoutRequestID)) {
    ...
    $stmt = $conn->prepare("INSERT INTO payments (phone_number, total_amount, status) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $phone_number, $total_amount, $payment_status);
